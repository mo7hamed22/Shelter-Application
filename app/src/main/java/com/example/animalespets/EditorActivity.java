...
import com.example.animalespets.data.pets.PetEntry;
...
public class EditorActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //Get the Intent
        ...
        //To make Title For the activity and know where come from
        //check If there is uri Send or Not
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mGender = pets.PetEntry.GENDER_MALE; // Male
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mGender = pets.PetEntry.GENDER_FEMALE; // Female
                    } else {
                        mGender =pets.PetEntry.GENDER_UNKNOWN; // Unknown
                    }
                }
            }
    ...
    private void savePet() {
      ...
      //  int weight = Integer.parseInt(weightString);
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(weightString) && mGender == pets.PetEntry.GENDER_UNKNOWN) {
        ...
        values.put(pets.PetEntry.COLUMN_PET_WEIGHT, weight);
